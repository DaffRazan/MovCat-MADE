...
class MainRepositoryTest {
   ...
   // remote movie and tv show responses
    ...
    @Test
    fun getMovies() {
        val dsFactory = mock(DataSource.Factory::class.java) as DataSource.Factory<Int, MovieEntity>
        `when`(local.getAllMovies("NEWEST")).thenReturn(dsFactory)
    ...
    fun getFavoriteTvShow() {
        val dsFactory = mock(DataSource.Factory::class.java) as DataSource.Factory<Int, TvShowEntity>
        `when`(local.getFavoriteTvShow()).thenReturn(dsFactory)
